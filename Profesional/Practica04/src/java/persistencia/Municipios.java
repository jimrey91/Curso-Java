...
@NamedQueries({
    ...
    @NamedQuery(name = "Municipios.findByMunicicpio", query = "SELECT m FROM Municipios m WHERE m.municicpio = :municicpio"),
...
public class Municipios implements Serializable {
    ...
    public Municipios(String codigoMunicipio, String municicpio, String codigoDepartamento, Date fechaCreacion) {
        this.codigoMunicipio = codigoMunicipio;
        this.municicpio = municicpio;
    ...
    public String getMunicicpio() {
        return municicpio;
    }

    public void setMunicicpio(String municicpio) {
        this.municicpio = municicpio;
    }
