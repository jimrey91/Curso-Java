 ...
 */
package sv.curso.intermedio.practica07.mantenimiento;

import java.math.BigDecimal;
import javax.persistence.EntityManager;
import sv.curso.intermedio.practica07.persistencia.Contribuyentes;
...
/*   MantenimientoContribuyentesJpa mantenimiento = new MantenimientoContribuyentesJpa();
     ...
     System.out.println("Respuesta: " + mantenimiento.modificarContribuyente("061406126201", 8000.00));     
     ...
     contribuyente.setNoNit("0614301070111");
     contribuyente.setNombreContribuyente("Open Source Solutions");
     contribuyente.setRazonSocial("Servicio de Capacitacion");
     contribuyente.setRepresentanteLegal("Jaime Reyes");
     contribuyente.setRentaAnual(new BigDecimal(6000.00));
    ...
    public int modificarContribuyente(String noNit, String nombreContribuyente, 
              String razonSocial, String representanteLegal, double rentaAnual){
